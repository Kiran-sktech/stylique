...
<head>
    ...
    <style>
        ...
        /* Banner Section */
        .banner {
            background: url('bg_of_her.jpg') center/cover no-repeat;
            height: 400px;
            position: relative;
            color: white;
        }
    ...
    <div class="products-section" id="lehenga">
        ...
        <div class="products" data-category="lehenga">
            <div class="product">
                ...
                <p>₹2900</p>
                <button onclick="openModal('Classy Lehengas', 'len3.jpg')">Rent Now</button>
            ...
            <div class="product">
                ...
                <p>₹3100</p>
                <button onclick="openModal('Classy Lehengas', 'len2.jpg')">Rent Now</button>
            ...
            <div class="product">
                ...
                <p>₹3500</p>
                <button onclick="openModal('Classy Lehengas', 'len1.jpg')">Rent Now</button>
            ...
            <div class="product">
                ...
                <p>₹2200</p>
                <button onclick="openModal('Classy Lehengas', 'len4.jpg')">Rent Now</button>
    ...
    <div class="products-section" id="saree">
        ...
        <div class="products" data-category="saree">
            <div class="product">
                ...
                <p>₹1200</p>
                <button onclick="openModal('Classy Lehengas', 'saree3.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="saree2.jpg" alt="Silk Saree">
                <h4>Silk Copper Enhanced Saree</h4>
                <p>₹999</p>
                <button onclick="openModal('Classy Lehengas', 'saree2.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="saree1.jpg" alt="Silk Saree">
                <h4>Silk Saree</h4>
                <p>₹1700</p>
                <button onclick="openModal('Classy Lehengas', 'saree1.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="saree4.jpg" alt="Silk Saree">
                <h4>Silk Silver Enhanced Saree</h4>
                <p>₹1100</p>
                <button onclick="openModal('Classy Lehengas', 'saree4.jpg')">Rent Now</button>
            </div>
        </div>
    </div>
    ...
    <div class="products-section" id="partywear">
        ...
        <div class="products" data-category="partywear">
            <div class="product">
                ...
                <p>₹900</p>
                <button onclick="openModal('Classy Lehengas', 'party3.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="party2.jpg" alt="Golden Gown">
                <h4>Golden Gown</h4>
                <p>₹1100</p>
                <button onclick="openModal('Classy Lehengas', 'party2.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="party1.jpg" alt="Silk Saree">
                <h4>Leaf Theme Beautiful Dress</h4>
                <p>₹850</p>
                <button onclick="openModal('Classy Lehengas', 'party1.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="party4.jpg" alt="Silk Saree">
                <h4>Navy Blue Net Dress</h4>
                <p>₹850</p>
                <button onclick="openModal('Classy Lehengas', 'party4.jpg')">Rent Now</button>
            </div>
        </div>
    </div>
    ...
    <div class="products-section" id="anarkali">
        ...
        <div class="products" data-category="anarkali">
            <div class="product">
                ...
                <p>₹600</p>
                <button onclick="openModal('Classy Lehengas', 'an3.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="an2.jpg" alt="Blue Anarkali">
                <h4>Blue Anarkali</h4>
                <p>₹700</p>
                <button onclick="openModal('Classy Lehengas', 'an2.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="an1.jpg" alt="Silk Saree">
                <h4>Green Anarkali</h4>
                <p>₹850</p>
                <button onclick="openModal('Classy Lehengas', 'an1.jpg')">Rent Now</button>
            </div>
            <div class="product">
                <img src="an4.jpg" alt="Silk Saree">
                <h4>Full Sleeves Anarkali</h4>
                <p>₹850</p>
                <button onclick="openModal('Classy Lehengas', 'an4.jpg')">Rent Now</button>
            </div>
        </div>
    </div>
    <!-- Scroll to Top Button -->
